...
function IssueItem({issue}) {
  ...
  >
    ...
    <div className='tw-space-x-2 tw-my-2 '>
    <span className=' tw-text-accent-gray tw-text-sm group-hover:tw-text-white '>Project : {issue.project.name}</span>
    <span className='tw-text-accent-gray tw-text-sm group-hover:tw-text-white'># {issue.project.id}</span>
    </div>
